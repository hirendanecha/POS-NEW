          ...
          >
            ...
            <View style={styles.section}>
              ...
              <View style={styles.inputGroup}>
                ...
                <TextInput
                  style={styles.input}
                  placeholder="e.g. Fresh Farms Agriculture LLC"
                  placeholderTextColor={ThemeColors.textMuted}
              ...
              <View style={{ flexDirection: "row", gap: ThemeSpacing.md }}>
                <View style={[styles.inputGroup, { flex: 1 }]}>
                  ...
                  <TextInput
                    ...
                    onChangeText={(t) => handleChange("contactPerson", t)}
                  />
                </View>
                <View style={[styles.inputGroup, { flex: 1 }]}>
              ...
              <View style={{ flexDirection: "row", gap: ThemeSpacing.md }}>
                <View style={[styles.inputGroup, { flex: 1 }]}>
                  ...
                  <TextInput
                    ...
                    onChangeText={(t) => handleChange("paymentTerms", t)}
                  />
                </View>
                <View style={[styles.inputGroup, { flex: 1 }]}>
                  ...
                  <TextInput
                    ...
                    onChangeText={(t) => handleChange("creditLimit", t)}
                  />
                </View>
              </View>
            </View>
