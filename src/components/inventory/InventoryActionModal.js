...
export function InventoryActionModal({
  ...
  const handleSubmit = () => {
    ...
    if (type === "adjustments" || type === "quarantine") {
      ...
      if (
        type === "quarantine" ||
        (type === "adjustments" && adjustmentType === "remove")
      ) {
        finalQty = -finalQty;
      }
  ...
  const getTitle = () => {
    switch (type) {
      ...
      case "quarantine":
        return "Log Quarantine Issue";
      case "replenish":
        return "Order Replenishment";
      default:
      ...
      case "quarantine":
        return (
          <>
            ...
            {type === "adjustments" && (
              <View style={styles.inputGroup}>
                ...
                >
                  ...
                  >
                    <Text
                      weight={adjustmentType === "add" ? "bold" : "regular"}
                      style={{
                        color:
                          adjustmentType === "add"
                            ? ThemeColors.amber
                  ...
                  >
                    <Text
                      weight={adjustmentType === "remove" ? "bold" : "regular"}
                      style={{
                        color:
                          adjustmentType === "remove"
                            ? ThemeColors.red
            ...
            <View
              style={{ flexDirection: "row", gap: ThemeSpacing.md, zIndex: 10 }}
            >
      ...
      default:
        return (
          <View style={styles.inputGroup}>
            ...
            <TextInput
              style={styles.input}
              placeholder="e.g. Aisle 4, Warehouse B"
              placeholderTextColor={ThemeColors.textMuted}
            />
          </View>
        );
          ...
          <View style={styles.body}>
            ...
            {error ? (
              ...
              >
                ...
                <Text style={{ color: ThemeColors.rose, fontSize: 13 }}>
                  {error}
                </Text>
              </View>
            ) : null}
