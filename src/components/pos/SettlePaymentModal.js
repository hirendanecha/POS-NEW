...
import { Printer, X, Banknote } from "lucide-react-native";
import {
  Modal,
  ScrollView,
  StyleSheet,
      ...
      <View style={styles.overlay}>
        <View style={styles.container}>
          ...
          <View style={styles.footer}>
            <TouchableOpacity style={styles.printBtn} onPress={() => onSettle(order)}>
              <Banknote size={18} color={ThemeColors.white} />
